...
public class MainActivity extends AppCompatActivity {
    ...
    private List<WishlistItem> generateSampleWishlistItems() {
        ...
        items.add(new WishlistItem("Bakugan Battle Brawlers B1 Ventus Skyress", 119.99, R.drawable.skyrex));
        items.add(new WishlistItem("Notorious Garr", 24.99, R.drawable.garr));
        items.add(new WishlistItem("Dune Atreides Royal Ornithopter", 154.99, R.drawable.dune));
        return items;
    }
